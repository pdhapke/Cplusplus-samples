...
int main()
{
	...
	cout << " Main, PI, RATE, radius, findArea, findCircumference" << endl << endl;

	{
		float area;

		cout << "Main function first inner block" << endl;
		cout << " Main, PI, RATE, radius, area, findArea, findCircumference" << endl << endl;
...

	{
		...
		cout << " Main, PI, RATE, radius (a local copy), circumference, findArea, findCircumference" << endl << endl;
...
void findArea(float rad, float& answer)
{
	...
	cout << "PI, RATE, rad, answer, findArea, findCircumference" << endl << endl;
...
void findCircumference(float length, float& distance)
{
	...
	cout << "PI, RATE, length, distance, findArea, findCircumference" << endl << endl;
