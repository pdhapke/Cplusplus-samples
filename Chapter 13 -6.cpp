...
class Inventory{
	...
	public: 
	//constructors
	Inventory(){itemNumber = quantity = cost = totalcost  = 0; }
...
int main(){
	...
	//this is here to increase the file size because at this size for some reason blackboard marked it as a security threat
